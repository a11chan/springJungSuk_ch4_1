      ...
      <c:forEach var="boardDto" items="${postingList}">
        <tr>
          <td class="no">${boardDto.bno}</td>
            <%--**4.08 c:out 태그로 내용 표현--%>
          <td class="title"><a href="<c:url value="/board/read${ph.sc.queryString}&bno=${boardDto.bno}"/>"><c:out
      ...
      <div class="paging">
        ...
        <c:if test="${totalPostings != null && totalPostings != 0}">
          ...
          <c:forEach var="i" begin="${ph.beginNaviPage}" end="${ph.endNaviPage}">
            <a class="page ${i==ph.sc.currentPage? "paging-active" : ""}"
